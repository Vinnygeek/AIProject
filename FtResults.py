...
def createCSV():
    ...
    csvData = [[10, 10], [10, 20], [10, 30], [10, 40]]
...
def plotScattered():
    ...
    x, y, z = np.loadtxt('person.csv', delimiter=',', unpack=True)
...
def plotScatteredNormalized():
    ...
    plt.xlabel("Population")
    plt.ylabel("N Generations")
    plt.title("Fitness Normalized")
    plt.show()

plotElitism()
#createCSV()
#plotScatteredNormalized()
